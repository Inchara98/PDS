...
class Test_001_Login:
    ...
    @pytest.mark.smoke
    def test_JennieHomepage(self,setup):
        ...
        time.sleep(3)
        self.CH.JennieHomepage()
        a = self.driver.current_url
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/Jennie":
            assert True
            self.logger.info("********************Test JennieHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_JennieHomepage.png")
            self.logger.info("********************JennieHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu10(self,setup):
        self.logger.info("********************verifying test_DashboardMenu8 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/JENNIE":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu10.png")
            self.logger.info("********************test_DashboardMenu10 ended********************************")
            assert False
