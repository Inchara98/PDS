...
class Test_001_Login:
    ...
    @pytest.mark.smoke
    def test_MajorHomepage(self,setup):
        ...
        time.sleep(3)
        self.CH.MajorHomepage()
        a = self.driver.current_url
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/MAJOR":
            assert True
            self.logger.info("********************Test MajorHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_MajorHomepage.png")
            self.logger.info("********************MajorHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu14(self,setup):
        self.logger.info("********************verifying test_DashboardMenu14 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/MAJOR":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu14.png")
            self.logger.info("********************test_DashboardMenu14 ended********************************")
            assert False
