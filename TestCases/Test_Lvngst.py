...
class Test_001_Login:
    ...
    @pytest.mark.smoke
    def test_LvngstHomepage(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/LVNGST":
            assert True
            self.logger.info("********************Test LvngstHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_LvngstHomepage.png")
            self.logger.info("********************LvngstHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu13(self,setup):
        self.logger.info("********************verifying test_DashboardMenu13 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/LVNGST":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu13.png")
            self.logger.info("********************test_DashboardMenu13 ended********************************")
            assert False
