...
from PageObjects.KingsHospital import KingsHospital
...
class Test_001_Login:
    ...
    def test_KingsHomepage(self,setup):
        ...
        self.CH = KingsHospital(self.driver)
        time.sleep(3)
        self.CH.KingsHomepage()
        a = self.driver.current_url
        if a == "https://pds-billing-info.tibilprojects.com/dashboard/KINGS":
            assert True
