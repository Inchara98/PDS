...
from PageObjects.VincentHospital import VincentHospital
...
class Test_001_Login:
    ...
    def test_VincentHomepage(self,setup):
        ...
        self.CH = VincentHospital(self.driver)
        time.sleep(3)
        self.CH.VincentHomepage()
        a = self.driver.current_url
        if a == "https://pds-billing-info.tibilprojects.com/dashboard/VINCENT":
            assert True
