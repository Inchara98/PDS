...
class Test_001_Login:
    ...
    @pytest.mark.smoke
    def test_VincentHomepage(self,setup):
        ...
        time.sleep(3)
        self.CH.VincentHomepage()
        a = self.driver.current_url
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/VINCENT":
            assert True
            self.logger.info("********************Test VincentHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_VincentHomepage.png")
            self.logger.info("********************VincentHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu23(self,setup):
        self.logger.info("********************verifying test_DashboardMenu23 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/VINCENT":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu23.png")
            self.logger.info("********************test_DashboardMenu23 ended********************************")
            assert False
