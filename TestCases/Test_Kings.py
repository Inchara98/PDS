...
class Test_001_Login:
    ...
    @pytest.mark.smoke
    def test_KingsHomepage(self,setup):
        ...
        time.sleep(3)
        self.CH.KingsHomepage()
        a = self.driver.current_url
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/KINGS":
            assert True
            self.logger.info("********************Test KingsHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_KingsHomepage.png")
            self.logger.info("********************KingsHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu11(self,setup):
        self.logger.info("********************verifying test_DashboardMenu11 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/KINGS":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu11.png")
            self.logger.info("********************test_DashboardMenu11 ended********************************")
            assert False
