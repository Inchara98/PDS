...
class Test_Hospital:
    ...
    @pytest.mark.smoke
    def test_SchnekHomepage(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/SCHNEK":
            assert True
            self.logger.info("********************Test SchnekHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_SchnekHomepage.png")
            self.logger.info("********************SchnekHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu20(self,setup):
        self.logger.info("********************verifying test_DashboardMenu20 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/SCHNEK":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu20.png")
            self.logger.info("********************test_DashboardMenu20 ended********************************")
            assert False
