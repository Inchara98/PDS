...
class Test_001_Login:
    ...
    def test_DashboardMenu7(self,setup):
        self.logger.info("********************verifying test_DashboardMenu7 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/HARRIS":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu7.png")
            self.logger.info("********************test_DashboardMenu7 ended********************************")
            assert False
