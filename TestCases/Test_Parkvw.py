...
class Test_Parkvw_Hospital:
    ...
    @pytest.mark.smoke
    def test_ParkvwHomepage(self,setup):
        ...
        time.sleep(3)
        self.CH.ParkvwHomepage()
        a = self.driver.current_url
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/PARKVW":
            assert True
            self.logger.info("********************Test ParkvwHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_ParkvwHomepage.png")
            self.logger.info("********************ParkvwHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu17(self,setup):
        self.logger.info("********************verifying test_DashboardMenu17 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/PARKVW":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu17.png")
            self.logger.info("********************test_DashboardMenu17 ended********************************")
            assert False
