...
class Test_UTMC_Hospital:
    ...
    @pytest.mark.smoke
    def test_UtmcHomepage(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/UTMC":
            assert True
            self.logger.info("********************Test UtmcHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_UtmcHomepage.png")
            self.logger.info("********************UtmcHomepage Test ended********************************")
            assert False
    ...
    #     time.sleep(5)
    #     self.driver.maximize_window()
    #     self.CH = UtmctHospital(self.driver)
    #     time.sleep(3)
    #     self.CH.UtmcHomepage()
    ...
    def test_DashboardMenu22(self,setup):
        self.logger.info("********************verifying test_DashboardMenu22 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/UTMC":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu22.png")
            self.logger.info("********************test_DashboardMenu22 ended********************************")
            assert False
