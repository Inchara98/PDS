...
class Test_001_Login:
    ...
    @pytest.mark.smoke
    def test_JasperHomepage(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/JASPER":
            assert True
            self.logger.info("********************Test JasperHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_JasperHomepage.png")
            self.logger.info("********************JasperHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu9(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/JASPER":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu9.png")
            self.logger.info("********************test_DashboardMenu9 ended********************************")
            assert False
