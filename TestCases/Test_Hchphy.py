...
class Test_001_Login:
    ...
    def test_HcCHhyHomepage(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/HCHPHY":
            assert True
            self.logger.info("********************Test HchphyHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_HchphyHomepage.png")
            self.logger.info("********************HchphyHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu8(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/HCHPHY":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu8.png")
            self.logger.info("********************test_DashboardMenu8 ended********************************")
            assert False
