...
class Test_Hospital:
    ...
    def test_ThehrtHomepage(self,setup):
        ...
        time.sleep(3)
        self.CH.ThehrtHomepage()
        a = self.driver.current_url
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/THEHRT":
            assert True
    ...
    def test_DashboardMenu21(self,setup):
        self.logger.info("********************verifying test_DashboardMenu21 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/THEHRT":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu21.png")
            self.logger.info("********************test_DashboardMenu21 ended********************************")
            assert False
