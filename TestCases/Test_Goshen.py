...
class Test_001_Login:
    ...
    @pytest.mark.smoke
    def test_GoshenHomepage(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/GOSHEN":
            assert True
            self.logger.info("********************Test GoshenHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_GoshenHomepage.png")
            self.logger.info("********************GoshenHomepage Test ended********************************")
            assert False
    ...
    #     time.sleep(5)
    #     self.driver.maximize_window()
    #     self.CH = GoshenHospital(self.driver)
    #     time.sleep(3)
    #     self.CH.GoshenHomepage()
    ...
    def test_DashboardMenu5(self,setup):
        self.logger.info("********************verifying test_DashboardMenu5 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/GOSHEN":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu5.png")
            self.logger.info("********************test_DashboardMenu5 ended********************************")
            assert False
