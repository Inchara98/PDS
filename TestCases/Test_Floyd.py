...
class Test_001_Login:
    ...
    @pytest.mark.smoke
    def test_FloydHomepage(self,setup):
        ...
        if a == "https://pds-billing-info.tibilprojects.com/dashboard/FLOYD":
            assert True
            self.logger.info("********************Test FloydHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_FloydHomepage.png")
            self.logger.info("********************FloydHomepage Test ended********************************")
            assert False
