...
class Test_Hospital:
    ...
    @pytest.mark.smoke
    def test_MemsbHomepage(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/MEMSB":
            assert True
            self.logger.info("********************Test MemsbHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_MemsbHomepage.png")
            self.logger.info("********************MemsbHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu15(self,setup):
        self.logger.info("********************verifying test_DashboardMenu15 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/MEMSB":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu15.png")
            self.logger.info("********************test_DashboardMenu15 ended********************************")
            assert False
