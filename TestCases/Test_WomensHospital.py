...
from PageObjects.WomensHospital import WomensHospital
from Logs.Log import log_Details
from Utilities.readProperties import ReadConfig


class Test_WomensHospital:
    ...
    @pytest.mark.smoke
    def test_WomensHospitalHomepage(self,setup):
        ...
        self.CH = WomensHospital(self.driver)
        time.sleep(3)
        self.CH.WomensHomepage()
        a = self.driver.current_url
        if a == "https://pds-billing-info.tibilprojects.com/dashboard/WOMENS%20HOSPITAL":
            assert True
            self.logger.info("********************Test WomensHospitalHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_WomensHospitalHomepage.png")
            self.logger.info("********************WomensHospitalHomepage Test ended********************************")
            assert False
