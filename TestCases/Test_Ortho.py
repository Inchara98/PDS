...
class Test_Ortho_Hospital:
    ...
    @pytest.mark.smoke
    def test_OrthoHomepage(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/ORTHO":
            assert True
            self.logger.info("********************Test OrthoHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_OrthoHomepage.png")
            self.logger.info("********************OrthoHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu16(self,setup):
        self.logger.info("********************verifying test_DashboardMenu16 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/ORTHO":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu16.png")
            self.logger.info("********************test_DashboardMenu16 ended********************************")
            assert False
