...
class Test_River:
    ...
    @pytest.mark.smoke
    def test_RiverHomepage(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/RIVER":
            assert True
            self.logger.info("********************Test RiverHomepage Passed********************************")
        else:
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_RiverHomepage.png")
            self.logger.info("********************RiverHomepage Test ended********************************")
            assert False
    ...
    def test_DashboardMenu19(self,setup):
        self.logger.info("********************verifying test_DashboardMenu19 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/RIVER":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu19.png")
            self.logger.info("********************test_DashboardMenu19 ended********************************")
            assert False
