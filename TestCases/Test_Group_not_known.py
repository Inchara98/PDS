...
class Test_001_Login:
    ...
    def test_Group_not_knownHomepage(self,setup):
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/GROUP_NOT_KNOWN":
            assert True
    ...
    def test_DashboardMenu6(self,setup):
        self.logger.info("********************verifying test_DashboardMenu6 Test********************************")
        self.driver = setup
        self.driver.get(self.baseUrl)
        self.lp = LoginPage(self.driver)
        self.lp.setUserName(self.username)
        ...
        if a == "https://uat-pds-billing-info.pdsnew.com/dashboard/GROUP_NOT_KNOWN":
            ...
            self.driver.save_screenshot("/home/inchara/PycharmProjects/PDS/Screenshots/" + "test_DashboardMenu6.png")
            self.logger.info("********************test_DashboardMenu6 ended********************************")
            assert False
